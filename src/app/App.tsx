...
function App() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-b from-gray-50 to-white">
      <header className="flex-none py-4 px-6 bg-gray-900">
        <div className="flex items-center max-w-5xl mx-auto">
          ...
          >
            <div className="text-xl font-semibold">
              <span className="text-white">AI Wellness</span>{" "}
      ...
      <footer className="flex-none border-t border-gray-200 bg-white/80 backdrop-blur-sm">
